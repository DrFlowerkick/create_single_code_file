    ...
    fn test_link_required_by_challenge() {
        ...
        assert_eq!(
            ...
            [
                ...
                "cg_fusion_binary_test (library crate)::Default for Go (Impl)",
                "cg_fusion_binary_test (library crate)::Default for Go (Impl)::default (Impl Fn)",
                "cg_fusion_binary_test (library crate)::Display for Value (Impl)",
                ...
                "cg_fusion_binary_test (library crate)::fmt (Use)",
